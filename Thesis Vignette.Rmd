...
# Sample WRDS Data
10-years of data, from 12/31/2006 to 12/31/2016, was collected from WRDS for IBM, Google, and Apple, to find their 252-day (annual) trailing volatility. 
```{r}
#IBM 252-day Trailing Vol from 12/31/2006 to 12/31/2016
ggplot(ibm, aes(Date, sd)) + ggtitle("IBM 252-day Trailing Vol") + geom_line() +
xlab("Time") + ylab("252-day rolling SD")

#Apple 252-day Trailing Vol from 12/31/2006 to 12/31/2016
ggplot(aapl, aes(Date, sd)) + ggtitle("AAPL 252-day Trailing Vol") + geom_line() +
xlab("Time") + ylab("252-day rolling SD")

#Microsoft 252-day Trailing Vol from 12/31/2006 to 12/31/2016
